...
Quaternion MakeRotateAxisAngleQuaternion(const Vector3 &axis, float angle) {
  ...
  float ax = axis.x * invLength;
  float ay = axis.y * invLength;
  float az = axis.z * invLength;
